                    ...
                    <>
                      ...
                      <div className="absolute right-0 mt-2 w-56 rounded-xl border border-slate-100 bg-white p-2 shadow-lg z-40 space-y-1">
                        ...
                        <Link
                          ...
                          className="flex items-center gap-2 px-3 py-2 text-xs font-semibold text-slate-600 rounded-lg hover:bg-slate-50 hover:text-slate-900 transition-colors w-full text-left"
                        >
                          <Settings className="h-3.5 w-3.5 text-slate-400" />
                          <span>{t("shell.farmSettings", "Farm Settings")}</span>
                        </Link>
