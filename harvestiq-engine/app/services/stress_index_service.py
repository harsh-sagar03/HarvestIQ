...
class StressIndexService:
    ...
    async def compute(self, farm_id: str, user_id: str) -> StressIndexResponse:
        context = await self._build_field_context(farm_id, user_id)
        result = self._calculate_fsi(context)
    ...
    def calculate_fsi_from_context(self, context: FieldContext) -> StressIndexResponse:
        return self._calculate_fsi(context)
    ...
    def _calculate_fsi(self, context: FieldContext) -> StressIndexResponse:
        ...
        explanation = build_fsi_explanation(fsi, classification, primary_factor, inputs)
