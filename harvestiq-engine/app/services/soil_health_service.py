...
class SoilHealthService:
    ...
    async def create_record(self, user_id: str, payload: SoilRecordCreateSchema) -> SoilRecordResponse:
    ...
    async def get_latest(self, user_id: str, farm_id: str) -> SoilRecordResponse | dict:
